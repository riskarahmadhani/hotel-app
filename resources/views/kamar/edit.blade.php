    ...
    <div class="row">
        <div class="col-6">
            <x-form-edit :action="route('kamar.update',['kamar'=>$row->id])" :upload="true"> 
                ...
                @endif
                <x-input label="Foto" name="foto" type="file" keterangan="Foto bertipe : png, jpg, jpeg. Dimensi : min width 1000px, min height 500px. Ukuran : min 50kb, max 1000kb. "/>
                ...
                <x-textarea label="Deskripsi Kamar" name="deskripsi" :value="$row->deskripsi_kamar"  />
            </x-form-edit>
        </div>
    </div>
@endsection