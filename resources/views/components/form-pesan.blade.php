    ...
    <div class="col-md">
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white border-0">Chek In</span>
            </div>
            <input type="date" name="checkin" class="form-control rounded" placeholder="Chek In">
        </div>
    </div>
    <div class="col-md">
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white border-0">Chek Out</span>
            </div>
            <input type="date" name="checkout" class="form-control rounded" placeholder="Chek Out">
        </div>
    </div>
    <div class="col-md-3">
        <div class="input-group">
